...
#	cd  /tmp
#    wget -q "https://github.com/Pulsar-Linux/kde-setup/archive/master.zip"
...
ANS=$(zenity --title="Pulsar - Desktops" --height=300 --list  --text "Choose your desired desktops" --checklist  --column "Installed" --column "Desktop" $GNOME_INSTALLED "Gnome" $CINNAMON_INSTALLED "Cinnamon" $KDE_INSTALLED "KDE" --separator="|")
